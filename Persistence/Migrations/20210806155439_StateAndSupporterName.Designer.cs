...
namespace Alorotbe.Persistence.Migrations
{
    ...
    [Migration("20210806155439_StateAndSupporterName")]
    partial class StateAndSupporterName
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.BasicInfo.State", b =>
                {
                    b.Property<int>("StateId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.BasicInfo.City", b =>
                {
                    b.HasOne("Core.BasicInfo.State", "State")
                        .WithMany()
